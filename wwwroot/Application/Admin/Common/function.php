 ...
 * @param int $flags
 */
function bs_scan_dir($pattern,$flags=null){
	$files = array_map('basename',glob($pattern, $flags));
	return $files;
}

/**
 * 清空系统缓存 add by heqh 2016/1/27 20:00:45
 */
function bs_clear_cache(){
	import('Util.Dir', BS_VENDOR_PATH);

	$dirs = array ();
	// runtime/
	$rootdirs = bs_scan_dir( RUNTIME_PATH."*" );
