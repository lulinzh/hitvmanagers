...
class Page
{
    ...
    private $config = array(
        'header' => '<li><span class="pageinfo">共 <strong>%TOTAL_PAGE%</strong>页<strong>%TOTAL_ROW%</strong>条</span></li>',
        'prev' => '上一页',
        'next' => '下一页',
        'first' => '首页',
        'last' => '末页',        // '...%TOTAL_PAGE%',
        'theme' => '%FIRST% %UP_PAGE% %LINK_PAGE% %DOWN_PAGE% %END% %HEADER%',   //  %FIRST% %UP_PAGE% %LINK_PAGE% %DOWN_PAGE% %END%',
    );
        ...
        for ($i = 1; $i <= $this->rollPage; $i++) {
            ...
            if ($page > 0 && $page != $this->nowPage) {
                ...
                if ($page > 0 && $this->totalPages != 1) {
                    $link_page .= '<li class="thisclass"><a class="current" href="#">' . $page . '</a></li>';
                }
            }
        }
